...
int main(int argc, char** argv) {
    ...
    if (rank == 0) {
        ...
        for (int i = 1; i < size; ++i) {
            ...
            // استقبال النتائج من العمليات الأخرى
            MPI_Recv(&received_integral, 1, MPI_DOUBLE, i, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
        ...
        std::cout << "MPI v1 (Point-to-Point) Integral Result: " << total_integral << std::endl;
